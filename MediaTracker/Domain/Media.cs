...
public abstract class Media : INotifyPropertyChanged
{
    ...
    [JsonIgnore] 
    private Color _baseDarkColor = Colors.Transparent;
    ...
    [JsonIgnore] 
    public string? BackupSaga { get; set; }

    [JsonIgnore] 
    public string? BackupNote { get; set; }

    [JsonIgnore] 
    public System.Windows.Media.Color BackupBaseColor { get; set; }
    ...
    [JsonIgnore] 
    public Action? ClearNewWatchDate;
